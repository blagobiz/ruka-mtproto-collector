...
Derived in part from the MIT-licensed project
"telegram-proxy-collector" by "саня".
...
async def main_async(args: argparse.Namespace) -> None:
    ...
    print('🚀 RUKA MTProto Collector v1.0')
    print('=' * 48)
...
def main() -> None:
    parser = argparse.ArgumentParser(description='🚀 RUKA MTProto Collector')
